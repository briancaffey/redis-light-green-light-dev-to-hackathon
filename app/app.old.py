"""
This file shows how I originally approached building the app
without the Redis OM package

Patterns:

- Keys are used heavily to query data
- pipelines are used to make multiple updates
